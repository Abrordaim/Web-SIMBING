    ...
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">
                Sistem Manajemen Bimbingan Skripsi
            </h1>
            <p class="text-sm sm:text-base text-gray-600">Masuk ke akun Anda untuk melanjutkan</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl p-6 sm:p-8">
            ...
            <form wire:submit="login" class="space-y-6">
                ...
                <button
                    type="submit"
                    class=" mt-5 w-full bg-blue-600 text-white py-3 rounded-lg font-medium hover:bg-blue-700 transition-colors shadow-lg hover:shadow-xl"
                >
                    Masuk
                </button>
            </form>
            ...
            >
                ...
                <span class="group-hover:text-gray-900 transition-colors">Masuk dengan Google</span>
            </a>
            ...
            <div class="mt-6 text-center">
                <p class="text-sm text-gray-600">
                    Belum punya akun?
                    <a href="{{ route('register') }}" class="text-blue-600 hover:text-blue-700 font-medium" wire:navigate>Daftar sekarang</a>
                </p>
            </div>
        </div>
